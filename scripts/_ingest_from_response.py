"""Ingest a raw get_equity_historicals single-symbol response file ({"data":{"results":[{"symbol":...,"bars":[...]}]}})
into data/prices/{symbol}.csv, filtering interpolated=true, dedup by date, sorted. Same output as _ingest.py."""
import sys, json, os, csv

with open(sys.argv[1]) as f:
    obj = json.load(f)

result = obj["data"]["results"][0]
